/*
 * video_out_x11.c Copyright (C) 2000-2002 Michel Lespinasse <walken@zoy.org>
                        ...
                        vo_setup_result_t *result, int xv)
{
...
#endif
    {
        ...
        /*
         * depth in X11 terminology land is the number of bits used to actually represent the
         *colour.
         *
         * bpp in X11 land means how many bits in the frame buffer per pixel.
         *
         * ex. 15 bit color is 15 bit depth and 16 bpp. Also 24 bit color is 24 bit depth, but can
         *be 24 bpp or 32 bpp.
         *
         * If we have blue in the lowest bit then "obviously" RGB (the guy who wrote this convention
         *never heard of endianness ?)
         */
