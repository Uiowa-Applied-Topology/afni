/*
 * yuv2rgb_mmx.c Copyright (C) 2000-2002 Silicon Integrated System Corp. All Rights Reserved.
 *
...
static inline void mmx_yuv2rgb(uint8_t *py, uint8_t *pu, uint8_t *pv)
{
    ...
    /*
     * Do the multiply part of the conversion for even and odd pixels register usage:
     * mm0 -> Cblue, mm1 -> Cred, mm2 -> Cgreen even pixels mm3 -> Cblue, mm4 -> Cred, mm5 -> Cgreen
     *odd  pixels mm6 -> Y even, mm7 -> Y odd
     */
    ...
    /*
     * Do the addition part of the conversion for even and odd pixels register usage:
     * mm0 -> Cblue, mm1 -> Cred, mm2 -> Cgreen even pixels mm3 -> Cblue, mm4 -> Cred, mm5 -> Cgreen
     *odd  pixels mm6 -> Y even, mm7 -> Y odd
     */
...
static inline void mmx_unpack_16rgb(uint8_t *image, const int cpu)
{
    ...
    /*
     * convert RGB plane to RGB 16 bits mm0 -> B, mm1 -> R, mm2 -> G mm4 -> GB, mm5 -> AR pixel 4-7
...
{
    /*
     * convert RGB plane to RGB packed format, mm0 -> B, mm1 -> R, mm2 -> G, mm3 -> 0, mm4 -> GB,
     *mm5 -> AR pixel 4-7, mm6 -> GB, mm7 -> AR pixel 0-3
     */
