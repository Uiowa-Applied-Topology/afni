/*
 * motion_comp_altivec.c Copyright (C) 2000-2002 Michel Lespinasse <walken@zoy.org>
 ...
 *
 * gcc-2.95 -fvec -D__ALTIVEC__ -O9 -fomit-frame-pointer -mregnames -S motion_comp_altivec.c
 *
