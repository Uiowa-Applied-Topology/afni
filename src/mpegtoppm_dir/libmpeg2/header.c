/*
 * header.c Copyright (C) 2000-2002 Michel Lespinasse <walken@zoy.org>
...
void mpeg2_header_sequence_finalize(mpeg2dec_t *mpeg2dec)
{
    ...
    /*
     * according to 6.1.1.6, repeat sequence headers should be identical to the original. However
     *some DVDs dont respect that and have different bitrates in the repeat sequence headers. So
     *we'll ignore that in the comparison and still consider these as repeat sequence headers.
     */
