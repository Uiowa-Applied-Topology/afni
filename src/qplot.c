...
int main(int argc, char *argv[])
{
    ...
    while (iarg < argc && argv[iarg][0] == '-')
    {
        ...
        if (strcmp(argv[iarg], "-ignore") == 0)
        {
            ...
            if (ignore < 0)
            {
                fprintf(stderr, "** Illegal -ignore value!\n"); exit(1);
            }
            iarg++; continue;
        }
        ...
        if (strcmp(argv[iarg], "-use") == 0)
        {
            ...
            if (use < 2)
            {
                fprintf(stderr, "** Illegal -use value!\n"); exit(1);
            }
            iarg++; continue;
        }
        ...
        if (strcmp(argv[iarg], "-dx") == 0)
        {
            ...
            if (dx <= 0.0)
            {
                fprintf(stderr, "** Illegal -dx value!\n"); exit(1);
            }
            iarg++; continue;
        }
