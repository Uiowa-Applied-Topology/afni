...
/*
 * This file contains routines to open and initialize models. The interface with the signal and
 *noise models is accomplished using dynamic libraries. This file was adapted from afni_plugin.c.
 *
 * File:     NLfit_model.c Author:   B. Douglas Ward Date:     23 June 1997
 *
 */
...
NLFIT_MODEL_array * NLFIT_get_many_MODELs(void)
{
    ...
    if (epath == NULL)
    {
        epath = efake;                     /* put in a fake path instead? */
    }
