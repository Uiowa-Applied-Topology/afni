...
/* CONFIGURE: If your system is >= 4.2BSD, set the BSD option; if you're a System V site, set the
* SYSV option; and if you're IBM-compatible, set MSDOS.  If your compiler is ANSI C, you're probably
* better off setting SYSV - all it affects is string handling.
*/
#define BSD
/* #define SYSV */
/* #define MSDOS */
...
#define ppm_hashpixel(p)    ((((long)PPM_GETR(p) * 33023 + (long)PPM_GETG(p) * 30013 + \
...
#endif /*__STDC__*/
{
    ...
    {
        /* Nope, we have to average the four corners.  This breaks the rules of pnm, but oh well.
        *  Let's try to do it portably. */
        switch (PNM_FORMAT_TYPE(format))
        {
        case PPM_TYPE:
            PPM_ASSIGN(bgxel,
...
#endif /*__STDC__*/
{
    ...
    {
        /* Nope, we have to average the two corners.  This breaks the rules of pnm, but oh well.
        *  Let's try to do it portably. */
        switch (PNM_FORMAT_TYPE(format))
        {
        case PPM_TYPE:
...
#if __STDC__
void
pnm_promoteformat(xel **xels, int cols, int rows, xelval maxval, int format, xelval newmaxval,
                  int newformat)
#else /*__STDC__*/
void
...
#if __STDC__
void
pnm_promoteformatrow(xel *xelrow, int cols, xelval maxval, int format, xelval newmaxval,
                     int newformat)
#else /*__STDC__*/
void
