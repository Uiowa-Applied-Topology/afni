...
/*
 * This file contains routines to initialize and implement the beta distribution function signal
 *model.
 *
 * File:     model_beta.c Author:   B. Douglas Ward Date:     11 December 1997
 */
 ...
 *
 *   gs[0] = time delay of response (t0) gs[1] = end of response (tf) gs[2] = multiplicative
 *constant (k) gs[3] = beta distribution parameter (alpha) gs[4] = beta distribution parameter
 *(beta)
 */
