...
/*
 * This file contains routines to initialize and implement the constant plus noise model.
 *
 * File:     model_constant.c Author:   B. Douglas Ward Date:     29 May 1997
 *
 */
...
/*
 * Routine to initialize the noise model by defining the number of parameters in the noise model,
 *the name of the noise model, and the default values for the minimum and maximum parameter
 *constraints.
 */
...
/*
 * Routine to calculate the time series which results from the constant plus noise model and model
 *parameters.
 *
