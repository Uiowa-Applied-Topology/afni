/* cg.f -- translated by f2c (version 19961017). You must link the resulting object file with the
 * libraries:
                         ...
                         integer *ierr)
{
    ...
    corth_(integer
           *,
           ...
           doublereal
           *, doublereal *), comqr_(integer *, integer *, integer
                                    *,
                                    integer *, doublereal *, doublereal *, doublereal *,
                                    doublereal
                                    *, integer *), cbabk2_(integer *, integer *, integer *,
                                                           integer
