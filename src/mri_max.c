...
intfloat mri_indmax_nz(MRI_IMAGE *im)
{
    ...
    case MRI_double: {
        ...
        for (ii = 0 ; ii < npix ; ii++)
        {
            ...
            if (qar[ii] > double_max)
            {
                double_max = qar[ii]; imax = ii;
            }
        }
...
intfloat mri_indmin_nz(MRI_IMAGE *im)
{
    ...
    case MRI_double: {
        ...
        for (ii = 0 ; ii < npix ; ii++)
        {
            ...
            if (qar[ii] < double_min)
            {
                double_min = qar[ii]; imin = ii;
            }
        }
