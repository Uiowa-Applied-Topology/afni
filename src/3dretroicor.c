/*****************************************************************************
*  3dretroicor.c: AFNI program to perform Retrospective Image Correction for physiological motion
* effects, using a slightly modified version of the RETROICOR algorithm described in:
*
*   Glover, G. H., Li, T., & Ress, D. (2000). Image-based method for retrospective correction of
* physiological motion effects in fMRI:
*  RETROICOR. Magnetic Resonance in Medicine, 44, 162-167.
*
*  Adapted from plug_retroicor.c.
*
*  Fred Tam Sunnybrook & Women's College Health Sciences Centre August 1, 2002
*
*  Copyright (C) 2002 Sunnybrook & Women's College Health Sciences Centre, Toronto, ON, Canada. As
* part of the AFNI software package, this software is distributed under the GNU General Public
