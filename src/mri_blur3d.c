    ...
    if (nx > 3)
    {
        ...
        for (kk = 0 ; kk < nz ; kk++)
        {
            for (jj = 0 ; jj < ny ; jj++)
            {
                ...
                r[1] = WT1 * f[off - D] + WT0 * f[off] + WT1 * f[off + D] + WT2 * f[off + 2 * D];
                off += D;
                for (ii = 2 ; ii < top ; ii++, off += D)
                {
                    r[ii] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 *
                            f[off + D] + WT2 * f[off + 2 * D];
                }
                r[ii] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 * f[off + D];
                off  += D; ii++;
    ...
    if (ny > 3)
    {
        ...
        for (kk = 0 ; kk < nz ; kk++)
        {
            for (ii = 0 ; ii < nx ; ii++)
            {
                ...
                {
                    r[jj] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 *
                            f[off + D] + WT2 * f[off + 2 * D];
                }
                r[jj] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 * f[off + D];
                off  += D; jj++;
    ...
    if (nz > 3)
    {
        ...
        for (jj = 0 ; jj < ny ; jj++)
        {
            for (ii = 0 ; ii < nx ; ii++)
            {
                ...
                {
                    r[kk] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 *
                            f[off + D] + WT2 * f[off + 2 * D];
                }
                r[kk] = WT2 * f[off - 2 * D] + WT1 * f[off - D] + WT0 * f[off] + WT1 * f[off + D];
                off  += D; kk++;
