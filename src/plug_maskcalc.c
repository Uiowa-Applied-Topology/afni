 ...
 *
 * $Log$
 * Revision 1.7  2005/04/19 21:07:17  rwcox Cput
 *
 * Revision 1.6  2004/01/07 19:50:37  rwcox Cput
 *
 * Revision 1.5  2003/07/15 13:28:30  rwcox Cput
 *
 * Revision 1.4  2003/06/25 20:45:07  rwcox Cput
 *
 * Revision 1.3  2000/12/21 16:10:54  cox AFNI
 *
 * Revision 1.1  1999/08/06 19:10:48  cox AFNI
 *
 * Revision 1.1  1998/11/12 18:11:06  rickr Initial revision
 *
 ***********************************************************************
 */
#include <stdio.h>
...
**
**	return  1 - successful completion 0 - failure
**
************************************************************************
*/
static char *
...
/***********************************************************************
**
**	Output statistics for each masked subbrick.  We are given a min and max value to further
**restrict our brick.
**
************************************************************************
*/
...
/***********************************************************************
**
**	Calculate the number of decimal places needed for a float given the magnitude and the total
**space.
**
************************************************************************
*/
    ...
    )
{
    ...
    /*
    ** Note that mptr and sptr get incremented continuously, where fptr gets incremented only when
    **we have a good mask value;
    */
    ...
    )
{
    ...
    /*
    ** Note that mptr and sptr get incremented continuously, where dptr gets incremented only when
    **we have a good mask value;
    */
    ...
    )
{
    ...
    for (sub = 0; sub < A->subs[data_index]; sub++)
    {
        ...
        /*
        ** Note that mptr and sptr get incremented continuously, where fptr gets incremented only
        **when we have a good mask value;
        */
...
**
**      If suffix is NULL, only consider filename. If filename already ends in the suffix, only
**consider filename. If the filename ends in a period, only add the suffix. Otherwise add a period
**and the suffix before checking its existence.
**
