 ...
 *
 * infrequent code is in poly2.c (all but top 50 and their callers 12/3/95)
 *
 ...
 *
 * qh_appendfacet( facet ) appends facet to end of qh.facet_list,
 *
 * returns:
 *  updates qh.newfacet_list, facet_next, facet_list increments qh.numfacets
 *
 * notes:
 ...
 *
 * qh_appendvertex( vertex ) appends vertex to end of qh.vertex_list,
 *
 * returns:
 *  sets vertex->newlist updates qh.vertex_list, newvertex_list increments qh.num_vertices
 *
 * notes:
 ...
 * >-------------------------------</a><a name="delfacet">-</a>
 *
 * qh_delfacet( facet ) removes facet from facet_list and frees up its memory
 *
 * notes:
 ...
 *
 * returns:
 *  deletes each facet and removes from facetlist at exit, qh.visible_list empty (==
 * qh.newfacet_list)
 *
 * notes:
 ...
 *
 * qh_makenewfacet( vertices, toporient, horizon ) creates a toporient? facet from vertices
 *
 * returns:
 ...
 *
 * qh_makenewplanes() make new hyperplanes for facets on qh.newfacet_list
 *
 * returns:
 ...
 *
 * qh_makenew_nonsimplicial( visible, apex, numnew ) make new facets for ridges of a visible facet
 *
 * returns:
...
facetT *qh_makenew_simplicial(facetT *visible, vertexT *apex, int *numnew)
{
    ...
    FOREACHneighbor_(visible)
    {
        ...
        {
            vertices = qh_facetintersect(neighbor, visible, &horizonskip, &visibleskip,
                                         1);
 ...
 *
 * qh_matchnewfacets() match newfacets in qh.newfacet_list to their newfacet neighbors
 *
 * returns:
...
void qh_matchnewfacets(void /* qh newfacet_list */)
{
    ...
    FORALLnew_facets {
        numnew++;
        {                                                 /* inline qh_setzero(newfacet->neighbors,
                                                           * 1, qh hull_dim); */
    ...
    qh_newhashtable(numnew * (qh hull_dim - 1)); /* twice what is normally needed, but every ridge
                                                  * could be DUPLICATEridge */
 ...
 *
 * design:
 *  set up pointers scan both sets checking for a match test orientation
 */
 ...
 * >-------------------------------</a><a name="newfacet">-</a>
 *
 * qh_newfacet() return a new facet
 *
 * returns:
 *  all fields initialized or cleared   (NULL) preallocates neighbors set
 */
 ...
 * >-------------------------------</a><a name="newridge">-</a>
 *
 * qh_newridge() return a new ridge
 */
 ...
 * >-------------------------------</a><a name="pointid">-</a>
 *
 * qh_pointid(  ) return id for a point, returns -3 if null, -2 if interior, or -1 if not known
 *
 * alternative code:
 *  unsigned long id;
 ...
 *
 * qh_removefacet( facet ) unlinks facet from qh.facet_list,
 *
 * returns:
 *  updates qh.facet_list .newfacet_list .facet_next visible_list decrements qh.num_facets
 *
 * see:
 *  qh_appendfacet
 */
 ...
 *
 * qh_removevertex( vertex ) unlinks vertex from qh.vertex_list,
 *
 * returns:
 *  updates qh.vertex_list .newvertex_list decrements qh.num_vertices
 */
