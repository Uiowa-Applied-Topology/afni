 ...
 *
 * if you recompile and load this module, then user.o will not be loaded from qhull.a
 *
 ...
 */
void qh_errprint(const char *string, facetT *atfacet, facetT *otherfacet, ridgeT *atridge,
                 vertexT *atvertex)
{
    int i;
 ...
 *
 * qh_printhelp_degenerate( fp ) prints descriptive message for precision error
 *
 * notes:
 ...
 *
 * qh_printhelp_narrowhull( minangle ) Warn about a narrow hull
 *
 * notes:
 ...
 *
 * qh_printhelp_singular( fp ) prints descriptive message for singular input
 */
 ...
 *
 * qh_user_memsizes() allocate up to 10 additional, quick allocation sizes
 *
 * notes:
