...
/*---------------------------------------------------------------
 * Linearly scale values so that largest value in volume is 10000 (255 for byte data volumes)
 * -----------------------------------------------------------------*/
