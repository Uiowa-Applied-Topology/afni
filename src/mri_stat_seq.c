...
/* Collect stats on sequence of images. Usage: call repeatedly, once for each image;  will return
 * void.
 *        after last image, call with NULL as argument, will return pointer to array of two pointers
 *to (float) images, the first the mean, the second the stdev.
 */
