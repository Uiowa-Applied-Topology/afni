...
/*! Find the byte order on this system. Return is either NI_LSB_FIRST or NI_MSB_FIRST. We are
 * assuming that there are only 2 possible order, which is of course false.
 * -----------------------------------------------------------------*/
