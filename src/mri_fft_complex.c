...
/*******
 * Note that thd_ballcorr.c has OpenMP compatible versions of these 3D FFT functions, which could
 *make your life better (or at least faster).
 ********/
/*----------------------------------------------------------------------------*/

/* FFT lengths are in Lxx, Lyy, Lzz; however, Lxx = 0 ==> no FFT in that direction (etc.).
 *//*--------------------------------------------------------------------------*/
...
/* Convolve (via FFT) image aim with bim.    [Sep 2020] Note output image will be at least as big as
 * than the sum of the two sizes.
 *//*--------------------------------------------------------------------------*/
