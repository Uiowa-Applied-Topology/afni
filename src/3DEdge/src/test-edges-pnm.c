...
static char *usage =
    "image-in image-out [-a %f] [-s %f] [-neg|-pos]\n\
...
int main(int argc, char *argv[])
{
    ...
    bufferOut = (void *)malloc(bufferDims[0] * bufferDims[1] * bufferDims[2] * nbytes *
