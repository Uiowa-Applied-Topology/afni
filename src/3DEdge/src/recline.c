 ...
 * DESCRIPTION:
 *
 * Recursive filtering of a line (a 1D array) Filter coefficient are static variables.
 *
 *
 * AUTHOR:
                                              ...
                                              derivativeOrder derivative)
{
    ...
    /*--- Selon le type de filtrage (filtres de Deriche, ou approximation de la gaussienne), x
     * designe soit alpha, soit sigma                         ---*/
    ...
    case GAUSSIAN_DERICHE:
        ...
        case DERIVATIVE_1:
            ...
            /*--- on multiplie les sommes par 2 car on n'a calcule que des demi-sommes et on change
             * le signe car la somme doit etre egale a -1              ---*/
            sumA *= (-2.0);
            sumC *= (-2.0);
            break;

        case DERIVATIVE_1_CONTOURS:
            /*--- la somme de 1 a l'infini est egale a 1 : cela introduit un petit biais (reponse un
             * rien superieur a la hauteur du step). Avec une somme de 0 a l'infini, c'est pire
             *                       ---*/
