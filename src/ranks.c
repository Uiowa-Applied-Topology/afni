 ...
 *
 * File:    ranks.c Author:  B. Douglas Ward Date:    31 March 2000
 *
 */
...
/*
 * Add number r to list; if number is already in the list, just increment the counter.  Otherwise,
 *insert new node.
 */
...
void node_allatonce(node **head, int nar, float *ar)
{
    ...
    *head = NULL; node_insert(head, ar[0]);
    ...
    for (ii = 1 ; ii < nar ; ii++)
    {
        ...
        {
            node_insert(&(ptr->next), r); ptr = ptr->next;
        }
    }
...
/*
 * Sort the input data array of floats, and return a new array containing the ranks of the input
 *data.
 */
...
/*
 * Sort the input data array of doubles, and return a new array containing the ranks of the input
 *data.
 */
