...
/*-----------------------------------------------------------------
 * utilities for writing char arrays to disk (replace 0's with ZBLOCK's, and vice-versa)
 * -------------------------------------------------------------------*/
...
/* same as zblock, but provide the replacement char, and do not change zb to a special character 12
 * Jul 2006 [rickr] */
