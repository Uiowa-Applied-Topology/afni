...
/***************************************************************
 * Sample plugout program to send the dataset (i,j,k) indices for viewing.
 ****************************************************************/
...
int afni_io(void)
{
    ...
    if (afni_mode == AFNI_OPEN_DATA_MODE)
    {
        ...
        if (afni_name[0] == '\0')
        {
            strcpy(afni_name, "aHorseCalledMan");
        }
    ...
    if (afni_mode == AFNI_CONTINUE_MODE)
    {
        ...
        if (ii < 3)
        {
            ...
            iochan_sleep(1000);
            ii = iochan_writecheck(afni_ioc, 5); if (ii < 0)
            {
                return -1;
            }
            return 0;
